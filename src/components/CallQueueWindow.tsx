...
const initialCalls: Call[] = [
  { id: 440, vpNumber: 533, plats: "Östra Stockholm", status: "Aktiv", duration: "00:30", operator: "8734", startTime: Date.now() - 30 * 1000, notes: "Pågående samtal.", polisInvolved: false, ambulansInvolved: false, isSpeakerphone: false },
  { id: 353, vpNumber: 558, plats: "Södra Stockholm", status: "Avslutad", duration: "02:15", operator: "9122", notes: "Avslutat ärende.", polisInvolved: false, ambulansInvolved: false, isSpeakerphone: false },
  { id: 352, vpNumber: 557, plats: "Västra Stockholm", status: "Avslutad", duration: "04:50", operator: "8734", notes: "Hanterad.", polisInvolved: true, polisUnitId: "P-112", ambulansInvolved: false, isSpeakerphone: false },
  { id: 351, vpNumber: 556, plats: "Norra Stockholm", status: "Avslutad", duration: "01:05", operator: "9122", notes: "Felringning.", polisInvolved: false, ambulansInvolved: false, isSpeakerphone: false },
  { id: 441, vpNumber: 534, plats: "Uppsala", status: "Inkommande", duration: "00:00", operator: "-", notes: "", isSpeakerphone: false },
  { id: 442, vpNumber: 535, plats: "Södertälje", status: "Väntande", duration: "01:10", operator: "8734", notes: "Väntar på koppling.", isSpeakerphone: false },
];


export const CallQueueWindow = ({ onClose }: { onClose?: () => void }) => {
  ...
  const triggerFakeCall = () => {
    ...
    setTimeout(() => {
      ...
      const fakeCall: Call = {
        id: newCallId,
        vpNumber: 999, // Added placeholder VP number
        plats: "Okänt Nummer", // Placeholder for fake call
        status: "Inkommande",
        duration: "00:00",
        operator: "-",
    ...
    >
      ...
      >
        <div className="flex items-center gap-1">
          ...
          <span className="text-sm font-medium text-black">Samtalskö</span>
        </div>
