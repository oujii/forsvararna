...
const initialCalls: Call[] = [
  ...
  { id: 895, vpNumber: 602, plats: "Västra Stockholm", status: "Väntande", duration: "01:30", operator: "8902", notes: "Väntar på ledig operatör.", isSpeakerphone: false },
  { id: 896, vpNumber: 603, plats: "Östra Stockholm", status: "Väntande", duration: "00:50", operator: "8115", notes: "Står i kö för vidarekoppling.", isSpeakerphone: false },
  { id: 897, vpNumber: 601, plats: "Södra Stockholm", status: "Aktiv", duration: "00:40", operator: "8231", startTime: Date.now() - 40 * 1000, notes: "Akut pågående samtal.", polisInvolved: false, ambulansInvolved: true, isSpeakerphone: false },
  { id: 898, vpNumber: 604, plats: "Norra Stockholm", status: "Väntande", duration: "02:10", operator: "8231", notes: "Väntar på patrull.", isSpeakerphone: false },
  
  { id: 899, vpNumber: 605, plats: "Uppsala", status: "Inkommande", duration: "00:00", operator: "-", notes: "", isSpeakerphone: true },
  { id: 900, vpNumber: 606, plats: "Södertälje", status: "Inkommande", duration: "00:00", operator: "-", notes: "", isSpeakerphone: true },
  
  { id: 901, vpNumber: 607, plats: "Östra Stockholm", status: "Avslutad", duration: "03:20", operator: "8902", notes: "Ingen vidare åtgärd.", polisInvolved: false, ambulansInvolved: false, isSpeakerphone: false },
  { id: 902, vpNumber: 608, plats: "Södra Stockholm", status: "Avslutad", duration: "04:10", operator: "8115", notes: "Anmälan registrerad.", polisInvolved: true, polisUnitId: "P-218", ambulansInvolved: false, isSpeakerphone: false },
];


export const CallQueue894Window = ({ onClose }: { onClose?: () => void }) => {
  ...
  const triggerFakeCall = () => {
    ...
    setTimeout(() => {
      ...
      const fakeCall: Call = {
        ...
        plats: "Västra Stockholm", // Placeholder for fake call
        status: "Inkommande",
        duration: "00:00",
        operator: "-",
    ...
    >
      ...
      >
        <div className="flex items-center gap-1">
          ...
          <span className="text-sm font-medium text-black">Samtalskö #894</span>
        </div>
